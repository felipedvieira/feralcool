...
const PRODUCTS = {
  "cereal-a": {
    ...
    desc: "Álcool cereal de alta pureza, produzido a partir de grãos selecionados. Ideal na fabricação de bebidas, perfumaria e cosméticos bem como na indústria farmacêutica e de extratos vegetais.",
  ...
  "hidratado-a": {
    ...
    desc: "O Álcool Etílico Hidratado 96° é uma solução de etanol obtida por destilação fracionada. Se distingue pelo seu elevado teor alcoólico, que o torna especialmente valorizado como solvente industrial de alta eficiência, matéria-prima química e insumo para a indústria de tintas, revestimentos, cosméticos e síntese orgânica. É um produto com características distintas do álcool a 70%: menos indicado para higienização direta de superfícies (pela menor eficiência biocida em alta concentração) e altamente aplicável onde se exige poder de solvência elevado e baixo teor de água.",
    tags: ["Alto teor alcoólico", "Hidratado", "Granel"],
    specs: [
      { label: "Teor Alcoólico", value: "96° GL" },
  ...
  "hidratado-b": {
    ...
    tags: ["Higienização", "Hospitalar", "Granel"],
    specs: [
      { label: "Teor Alcoólico", value: "70° GL" },
      { label: "Tipo", value: "Hidratado" },
      { label: "Embalagens", value: "Granel / 5L / 20L / 50L" },
      { label: "Validade", value: "24 meses" },
    ],
  ...
  "hidratado-c": {
    ...
    desc: "Álcool hidratado para uso doméstico e comercial. Eficaz na limpeza de superfícies, compomentes eletrônicos, remoção de manchas e como agente desinfetante geral.",
    tags: ["Doméstico", "Multiuso", "Granel"],
    specs: [
      { label: "Teor Alcoólico", value: "99.9° GL" },
      { label: "Tipo", value: "Hidratado" },
      { label: "Embalagens", value: "Granel / 500ml / 1L / 5L" },
